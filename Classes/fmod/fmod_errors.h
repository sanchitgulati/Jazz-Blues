...
/* ================================================================================================== */
/* FMOD Studio - Error string header file. Copyright (c), Firelight Technologies Pty, Ltd. 2004-2014. */
/*                                                                                                    */
...
/*$ preserve end $*/
        ...
        case FMOD_ERR_SUBSOUNDS:                 return "The error occured because the sound referenced contains subsounds when it shouldn't have, or it doesn't contain subsounds when it should have.  The operation may also not be able to be performed on a parent sound.";
        ...
        case FMOD_ERR_EVENT_WONT_STOP:           return "The event cannot be released because it will not terminate, call stop to allow releasing of this event.";
