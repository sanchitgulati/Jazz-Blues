...
#define FMOD_VERSION    0x00010417
...
typedef enum
{
    ...
    FMOD_ERRORCALLBACK_INSTANCETYPE_STUDIO_MIXERSTRIP,
...
typedef FMOD_RESULT (F_CALLBACK *FMOD_FILE_OPEN_CALLBACK)       (const char *name, int unicode, unsigned int *filesize, void **handle, void *userdata);
...
typedef FMOD_RESULT (F_CALLBACK *FMOD_FILE_ASYNCCANCEL_CALLBACK)(void *handle, void *userdata);
