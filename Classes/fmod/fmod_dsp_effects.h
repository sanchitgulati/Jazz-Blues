...
typedef enum
{
    FMOD_DSP_RETURN_ID,             /* (Type:int) - ID of this Return DSP. Read-only.  Default = -1*/
    FMOD_DSP_RETURN_INPUT_FORMAT    /* (Type:int) - Input format of this return.  0 = mono, 1 = stereo, 2 = 'surround'.  Surround = the speaker format of the mixer.  Default = 2.*/
} FMOD_DSP_RETURN;
